...
* 예시(4를 찾는 경우)
    ...
    * $중간값>원하는 값$ 이므로 왼쪽구간 탐색 및 끝점, 중간점 재설정 및 값 비교  
    ![Alt text]([image-1.png](https://github.com/Sbeom12/study/blob/main/%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98%20%EC%A0%95%EB%A6%AC/%EC%9D%B4%EB%AF%B8%EC%A7%80/image-1.png?raw=true))
